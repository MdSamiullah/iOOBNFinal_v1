...
public interface mxICell
{
	...
	/**
	 * Sets the nodeInfoBN of the cell to the given BasicNode.
	 * 
	 * @param bn BasicNode that represents the new BasicNode.
	 */
	
	void setBNInfo(BasicNode bn);
	
	/**
	 * Returns BN info of a  Cell if it is a vertex.
	 * 
	 * @return Returns a node's BasicNode info.
	 */
	BasicNode getBNInfo();
