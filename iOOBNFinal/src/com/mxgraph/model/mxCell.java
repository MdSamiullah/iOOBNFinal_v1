...
public class mxCell implements mxICell, Cloneable, Serializable
{
	...
	/**
	 * Holds the BN info for the cell. Default is null.
	 */
	protected BasicNode nodeInfoBN;
...
//	public static int utilityNodeCount = 0;
	...
	public mxCell(Object value, mxGeometry geometry, String style, BasicNode bn)
	{
		setValue(value);
	...
	public void setBNInfo(BasicNode bn)
	{
		this.nodeInfoBN = bn;
	}
...
//		clone.setBNInfo(getBNInfo());// the commenting of this line is very important. 
									 //if you open it and replace the next line then cloned cell will also contain 
									 //same information BasicNode which leads to a big problem like parents those are 
									 //parents of original will be copied
		clone.setBNInfo(new BasicNode());
