...
//			c.setVertex(true);
//			c.setValue("");
//			c.setGeometry(new mxGeometry(300, 200, 50, 50));
//			c.setStyle("ellipse");
//			cells[0] = (Object) c;
//		}
...
//		System.out.println(group.toString());
	 ...
	 */
	public Object insertVertex(Object parent, String id, Object value,
			double x, double y, double width, double height, String style, BasicNode bn)
	{
			...
			boolean relative, BasicNode bn)
	{
		...
		mxCell vertex = new mxCell(value, geometry, style, bn);
		vertex.setId(id);
	...
	public Object createEdge(Object parent, String id, Object value,
			Object source, Object target, String style)
	{
		mxCell edge = new mxCell(value, new mxGeometry(), style, null);// for edges BasicNode info is null
	...
	public boolean isCellBendable(Object cell)
	{
		...
		return isCellsBendable() && !isCellLocked(cell)
				&& mxUtils.isTrue(style, mxConstants.STYLE_BENDABLE, false);
	}
