...
public class mxSvgCanvas extends mxBasicCanvas
{
			...
			Map<String, Object> style)
	{
		...
		else if (shape.equals(mxConstants.SHAPE_DOUBLE_RHOMBUS))
		{
			...
			d = "M " + (x + (w - inset) / 2) + " " + y + " L " + (x + (w - inset)) + " "
					+ (y + (h - inset) / 2) + " L " + (x + (w - inset) / 2) + " " + (y + (h - inset)) + " L "
					+ x + " " + (y + (h - inset) / 2);
			
			foreground.setAttribute("d", d + " Z");
			elem.appendChild(foreground);
		}
		...
		else if (shape.equals(mxConstants.SHAPE_DOUBLE_HEXAGON))
		{
			...
			if (direction.equals(mxConstants.DIRECTION_NORTH)
					|| direction.equals(mxConstants.DIRECTION_SOUTH))
			{
				d = "M " + (x + 0.5 * w) + " " + (y + inset) + " L " + (x + (w - inset)) + " "
						+ (y + 0.25 * h) + " L " + (x + (w - inset)) + " "
						+ (y + 0.75 * h) + " L " + (x + 0.5 * w) + " "
						+ (y + (h - inset)) + " L " + (x+inset) + " " + (y + 0.75 * h) + " L "
						+ (x+inset) + " " + (y + 0.25 * h);
			}
			else
			{
				d = "M " + (x + 0.25 * w + inset) + " " + (y+inset) + " L " + (x + 0.75 * w - inset)
						+ " " + (y+inset) + " L " + (x + (w - inset)) + " " + (y + 0.5 * h)
						+ " L " + (x + 0.75 * w - inset) + " " + (y + (h - inset)) + " L "
						+ (x + 0.25 * w - inset) + " " + (y + (h - inset)) + " L " + (x+inset) + " "
						+ (y + 0.5 * h);
			}
