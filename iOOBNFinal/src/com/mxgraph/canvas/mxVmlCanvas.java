...
public class mxVmlCanvas extends mxBasicCanvas
{
			...
			Map<String, Object> style)
	{
		...
		else if (shape.equals(mxConstants.SHAPE_DOUBLE_RHOMBUS))
		{
			...
			String points = "m " + ((w - inset) / 2) + " 0 l " + (w - inset) + " " + ((h - inset) / 2)
					+ " l " + ((w - inset) / 2) + " " + (h - inset) + " l 0 " + ((h - inset) / 2);
		...
		else if (shape.equals(mxConstants.SHAPE_DOUBLE_HEXAGON))
		{
			int inset = (int) ((3 + strokeWidth) * scale);
			...
			if (direction.equals(mxConstants.DIRECTION_NORTH)
					|| direction.equals(mxConstants.DIRECTION_SOUTH))
			{
				points = "m " + (int) (0.5 * w) + " 0 l " + (w - inset) + " "
						+ (int) (0.25 * (h - inset)) + " l " + (w - inset) + " " + (int) (0.75 * (h - inset))
						+ " l " + (int) (0.5 * (w - inset)) + " " + (h - inset) + " l 0 "
						+ (int) (0.75 * (h - inset)) + " l 0 " + (int) (0.25 * (h - inset));
			}
			else
			{
				points = "m " + (int) (0.25 * (w - inset)) + " 0 l " + (int) (0.75 * (w - inset))
						+ " 0 l " + (w - inset) + " " + (int) (0.5 * (h - inset)) + " l "
						+ (int) (0.75 * (w - inset)) + " " + (h - inset) + " l " + (int) (0.25 * (w - inset))
						+ " " + (h - inset) + " l 0 " + (int) (0.5 * (h - inset));
			}
