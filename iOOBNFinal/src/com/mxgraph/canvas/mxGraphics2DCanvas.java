...
import com.mxgraph.shape.mxDoubleHexagonShape;
import com.mxgraph.shape.mxDoubleRectangleShape;
import com.mxgraph.shape.mxDoubleRhombusShape;
...
public class mxGraphics2DCanvas extends mxBasicCanvas
{
	...
	static
	{
		...
		putShape(mxConstants.SHAPE_DOUBLE_RHOMBUS, new mxDoubleRhombusShape());
		putShape(mxConstants.SHAPE_DOUBLE_HEXAGON, new mxDoubleHexagonShape());
	...
	public Stroke createStroke(Map<String, Object> style)
	{
		double width = mxUtils
				.getFloat(style, mxConstants.STYLE_STROKEWIDTH, 2) * scale;
