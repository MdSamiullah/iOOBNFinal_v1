...
public class EditorAboutFrame extends JDialog
{
	...
	public EditorAboutFrame(Frame owner)
	{
		...
		JLabel subtitleLabel = new JLabel(
				"For more information email to msam34@student.monash.edu");
		...
		content.add(new JLabel("iOOBN - A Bayesian Network Modelling Tool"));
		content.add(new JLabel(" "));

		content.add(new JLabel("iOOBN Version " + mxGraph.VERSION));
		content.add(new JLabel("Copyright (C) 2017 by Faculty of IT, Monash University, Australia."));
