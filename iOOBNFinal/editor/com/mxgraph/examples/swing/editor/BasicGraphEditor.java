...
//		outer.setBounds(250, 250, 1024, 800);
...
//				.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
		...
		libraryPane.setPreferredSize(new Dimension(20, 37));
		
		final boolean showTabsHeader = false;
		libraryPane.setUI(new javax.swing.plaf.metal.MetalTabbedPaneUI(){
	        @Override
...
//				w = 10;
	...
	public void exit()
	{
		...
		if (frame != null)
		{
			ExitAction exAct = new ExitAction();
//			exAct.actionPerformed(null);
			frame.dispose();
		}
	}
		    ...
		    public void windowClosing(java.awt.event.WindowEvent windowEvent) {
		        if (JOptionPane.showConfirmDialog(frame, 
		            ...
		            JOptionPane.QUESTION_MESSAGE) == JOptionPane.YES_OPTION){
			        	ExitAction exAct = new ExitAction();
			        	exAct.actionPerformed(new ActionEvent(this, ActionEvent.ACTION_PERFORMED, null));
			            System.exit(0);
		        }
		    }
		});
